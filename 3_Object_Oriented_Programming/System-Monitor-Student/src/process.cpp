...
float Process::CpuUtilization() { return _CpuUtilization=LinuxParser::CpuUtilization(_pid); }
...
bool Process::operator<(Process const& a) const { return a._CpuUtilization<_CpuUtilization; }