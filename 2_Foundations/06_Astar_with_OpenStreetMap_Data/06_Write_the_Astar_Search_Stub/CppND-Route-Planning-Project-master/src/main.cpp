...
int main(int argc, const char **argv)
{
    ...
    3.In main.cpp call AStarSearch on the RoutePlanner object.
        This should happen just after the RoutePlanner object is defined,
        but before the Render render{model}.
    */
    //Start perforance A*
    route_planner.AStarSearch();
    std::cout << "total distance: " << route_planner.GetDistance() << " meters"
              << "\n";
